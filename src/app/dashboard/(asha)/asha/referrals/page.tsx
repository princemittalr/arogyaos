...
export default function AshaReferralsPage() {
  ...
  const { data, isLoading } = useAshaModuleData(workerId, 'referrals');
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Referrals" 
        description="Manage patient referrals sent to Primary Health Centers or District Hospitals." 
      />
      {!data || data.length === 0 ? (
        ...
        <EmptyState 
          ...
          description="You have not created any pending hospital referrals."
