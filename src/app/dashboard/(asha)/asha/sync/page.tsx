...
export default function AshaSyncPage() {
  ...
  const { data, isLoading } = useAshaModuleData(workerId, 'sync');
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Offline Sync" 
        description="Manage your offline queue and resolve any sync conflicts." 
      />
      {!data || data.length === 0 ? (
        ...
        <EmptyState 
          ...
          description="There are no pending offline records. Your data is up to date with the server."
