...
export default function AshaVisitsPage() {
  ...
  const { data, isLoading } = useAshaModuleData(workerId, 'visits');
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="Plan your daily route and track completed household check-ins." 
      />
      {!data || data.length === 0 ? (
        ...
        <EmptyState 
          ...
          description="Your visit planner is clear for today. You can manually schedule check-ins or wait for system assignments."
