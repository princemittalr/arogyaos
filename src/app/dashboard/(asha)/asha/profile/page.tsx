...
export default function AshaProfilePage() {
  ...
  const { data, isLoading } = useAshaModuleData(workerId, 'profile');
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="View your assigned village details, supervisor information, and performance stats." 
      />
      {!data || data.length === 0 ? (
        ...
        <EmptyState 
          ...
          description="Your profile details are currently missing."
