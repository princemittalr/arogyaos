...
export default function AshaSurveysPage() {
  ...
  const { data, isLoading } = useAshaModuleData(workerId, 'surveys');
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="Conduct and submit community health surveys on sanitation, water, and nutrition." 
      />
      {!data || data.length === 0 ? (
        ...
        <EmptyState 
          ...
          description="There are no active survey campaigns assigned to you at the moment."
