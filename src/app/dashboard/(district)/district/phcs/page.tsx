...
export default function DistrictPHCsPage() {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Primary Health Centers (PHCs)"
        description="Audit primary clinics and rural health outposts monitoring general patient outreach."
      />
        ...
        <table className="w-full text-left border-collapse text-xs font-semibold text-slate-700 dark:text-slate-350">
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-950 border-b border-slate-150 dark:border-slate-850 text-slate-450 text-[10px] uppercase font-bold">
              <th className="p-4">PHC Center Name</th>
