  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Inspect medical ward structures, occupancy parameters, room categories and bed quotas."
      />
          ...
          return (
            ...
            >
              <div>
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-extrabold text-sm text-slate-900 dark:text-slate-55">Room {r.roomNumber}</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mt-6 border-t border-slate-100 dark:border-slate-850 pt-4 text-center">
                  <div className="bg-slate-50/50 dark:bg-slate-950/20 p-2.5 rounded-xl">
                    ...
                    <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wide">Occupied beds</span>
                  </div>
                  <div className="bg-slate-50/50 dark:bg-slate-950/20 p-2.5 rounded-xl">
                    <span className="block text-lg font-extrabold text-slate-900 dark:text-slate-50">{availabilityCount}</span>
                    <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wide">Available slots</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-5 pt-3 border-t border-slate-100 dark:border-slate-850 flex justify-between items-center text-[9px] text-slate-400 font-bold">
                <span>Room ID: {r.roomId.split('_').pop()}</span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-xs">
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-350 mb-1">Room Number</label>
                  <input
                    type="text"
                    {...register('roomNumber')}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block font-bold text-slate-700 dark:text-slate-350 mb-1">Room Type</label>
                    <select
                      {...register('roomType')}
                  ...
                  <div>
                    <label className="block font-bold text-slate-700 dark:text-slate-350 mb-1">Total Capacity</label>
                    <input
                      type="number"
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-350 mb-1">Occupied Beds</label>
                  <input
                    type="number"
