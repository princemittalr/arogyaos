  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Inspect medical department performance stats, track stock procurement reports, and generate audit summaries."
      />
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex justify-between items-start">
            <span className="text-xs text-slate-500 font-bold uppercase tracking-wider">Patient Volume</span>
            <TrendingUp className="h-5 w-5 text-emerald-500" />
          </div>
          <p className="text-3xl font-extrabold text-slate-900 dark:text-slate-50 mt-2">1,240</p>
          <p className="text-[10px] text-slate-450 font-semibold mt-1">+14% increase vs last period</p>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex justify-between items-start">
            <span className="text-xs text-slate-500 font-bold uppercase tracking-wider">Bed Occupancy Mean</span>
            <BarChart2 className="h-5 w-5 text-blue-500" />
          </div>
          <p className="text-3xl font-extrabold text-slate-900 dark:text-slate-50 mt-2">78%</p>
          <p className="text-[10px] text-slate-450 font-semibold mt-1">Average ward utilization rate</p>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex justify-between items-start">
            <span className="text-xs text-slate-500 font-bold uppercase tracking-wider">Pharmacy Restocks</span>
          ...
          <p className="text-[10px] text-slate-450 font-semibold mt-1">procured medicine items</p>
        </div>
      </div>

      {/* Available Documents */}
      <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
        <h3 className="font-extrabold text-sm text-slate-900 dark:text-slate-50 mb-6">Generated Reports</h3>
        <div className="space-y-3.5">
          {[
            { title: 'Clinical Bed Occupancy Trend Audit', size: '1.2 MB', date: '2026-07-05' },
            { title: 'Department Consultation Performance Registry', size: '890 KB', date: '2026-07-04' },
            { title: 'Pharmacy Stock Level Deficiency Report', size: '420 KB', date: '2026-07-01' },
          ].map((rep, idx) => (
            <div key={idx} className="flex justify-between items-center p-3.5 rounded-xl border border-slate-150 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-850 transition">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-semibold">Generated: {rep.date} &bull; File Size: {rep.size}</p>
                </div>
              </div>
