        ...
        <Suspense
          fallback={
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              <Spinner className="h-9 w-9 animate-spin text-blue-600 dark:text-blue-400" />
              <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500 animate-pulse">Initializing Interface...</p>
            </div>
          }
        >
          <ResetPasswordForm />
